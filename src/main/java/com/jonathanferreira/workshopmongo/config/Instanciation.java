package com.jonathanferreira.workshopmongo.config;
...
import com.jonathanferreira.workshopmongo.dto.AuthorDTO;
import com.jonathanferreira.workshopmongo.dto.CommentDTO;
...
public class Instanciation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		CommentDTO c2 = new CommentDTO("Flw", sdf.parse("21/03/2018"), new AuthorDTO(bob));
		CommentDTO c3 = new CommentDTO("Vlw", sdf.parse("21/03/2018"), new AuthorDTO(maria));
